...
public final class Hard extends AbstractWave0 {
    ...
    public void updateLevel(final LevelContext ctx, final float dt) {
        switch (++cycles) {
            ...
            case 180:
            case 200:
                this.singleShotEnemiesDownwards(ctx.getGame(), cycles / 4 * 5);
                break;
            case 300:
            case 400:
            case 500:
            ...
            case 780:
            case 800:
                this.singleShotEnemiesDownwards(ctx.getGame(), (cycles / 4 / 5 - 30) * 25);
                break;
            default:
