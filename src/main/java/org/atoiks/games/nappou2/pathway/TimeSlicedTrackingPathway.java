 ...
 */
public final class TimeSlicedTrackingPathway extends TrackingPathway {
    ...
    public TimeSlicedTrackingPathway(Trackable entity, float pathScale, float moveTime, float delay) {
        this(Vector2.ZERO, entity, pathScale, moveTime, delay);
    }

    public TimeSlicedTrackingPathway(Vector2 pos, Trackable entity, float pathScale, float moveTime, float delay) {
        super(entity);
